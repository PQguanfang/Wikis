...
* `XX_xx.json` file: Localized files automatically generated through [Localized Item Name](../advanced/localized-item-name-premium.md) feature. The name of this file is determined based on the localized language you have set for this feature, but it usually ends in `. json`.
* `XX.txt` file: The transaction record file generated by the [Log Transaction](../advanced/log-transaction-premium.md) feature is named using the log-transaction.file option in the config. yml file.
