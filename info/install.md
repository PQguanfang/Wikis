...
* When using the [Localized Item Name](../advanced/localized-item-name-premium.md) feature, it is important to note that when switching server game versions, the previously generated localized files need to be deleted.
