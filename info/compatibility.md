...
* [Save Item](../features/saved-item-item-manager.md): We told you a command called `/shop saveitem` at [Commands](commands.md) page, we also told you can set `material` option in [Item Format](../format/itemformat-tm/)  to the save item ID you was set to use them.
