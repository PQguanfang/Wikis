...
Please view [Shops](../base/shops.md) page for info.
...
You can reset the buy times or sell times by commands or auto reset feature, you can find them at [Commands](../base/commands.md) page and [Shops](../base/shops.md) page.
