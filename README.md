...
* In premium version, we just added more features:
  ...
  * Better Command Usage: Support more command format and have better experience for command usage, for more info, please view [Commands](base/commands.md) page.
